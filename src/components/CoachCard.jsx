            ...
            <div className="p-4 flex-grow flex flex-col justify-between">
                ...
                <div className="flex flex-col sm:flex-row gap-2 mt-4">
                    <button
                        ...
                        className="flex-1 bg-gradient-to-r from-fuschia-500 to-violet-500 text-white font-bold py-2 px-3 rounded hover:from-fuschia-600 hover:to-violet-600 flex items-center justify-center text-sm"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 bg-gray-200 text-gray-700 font-bold py-2 px-3 rounded hover:bg-gray-300 flex items-center justify-center text-sm"
                    >
